...
export const createMonthlyBudget = async (data: Omit<MonthlyBudget, "id">) => await db.monthlyBudget.create({ data });

export const updateMonthlyBudget = async (data: Pick<MonthlyBudget, "amount" | "id">) => await db.monthlyBudget.update({ where: { id: data.id }, data });
